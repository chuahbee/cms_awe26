...
STATIC_PREFIX = config("DJANGO_STATIC_PREFIX", default="")

STATIC_ROOT = config("DJANGO_STATIC_ROOT", default=os.path.join(BASE_DIR, "static"))
# STATIC_ROOT = os.path.join(BASE_DIR, "static")
STATIC_URL = f"{STATIC_PREFIX}/awe25/static/"

# MEDIA_ROOT = os.path.join(BASE_DIR, "media")
# MEDIA_URL = f"{STATIC_PREFIX}/awe25/media/"

MEDIA_ROOT = config("DJANGO_MEDIA_ROOT", default=os.path.join(BASE_DIR, "media"))
MEDIA_URL = config("DJANGO_MEDIA_URL", default="/awe25/media/")
...
WAGTAILADMIN_BASE_URL = "https://smartsuppliers.site/awe25"
